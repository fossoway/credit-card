...
var _maskedTextField = require("masked-text-field");
var _maskedTextFieldDefault = parcelHelpers.interopDefault(_maskedTextField);
const cardCheckout = ()=>{
    ...
    const button = (0, _redom.el)("button", {
    ...
    number.addEventListener("input", ({ target: element  })=>{
        element.value = (0, _maskedTextFieldDefault.default)(element.dataset.mask, element.value, element.dataset?.type);
...
},{}],"20Zq9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function useMask(mask, value, type = "number") {
    if (!mask || !value) throw Error("No mask or value was provided!");
